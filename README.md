...
* `/app`: Pantallas principales de autenticación y paneles de control específicos para deportistas, entrenadores y administración.
* `/assets`: Recursos gráficos, logotipos institucionales e iconos optimizados.